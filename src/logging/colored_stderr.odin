...
*/
format_colored_stderr_message :: proc(
    record: Log_Record,
) -> (
    res: string,
...
*/
create_colored_stderr_logger_from_namespace :: proc(
    ns: Namespace,
...
Create a new logger that writes to the standard error.
*/
create_colored_stderr_logger_from_namespace_string :: proc(
    ns: string,
    level: Log_Level = Log_Level.Info,
    enabled: bool = true,
) -> (
    ...
    return create_colored_stderr_logger_from_namespace(
            namespace,
            level,
            enabled,
        ),
...
Create a new logger that writes to the standard error.
*/
create_colored_stderr_logger :: proc {
    create_colored_stderr_logger_from_namespace,
    create_colored_stderr_logger_from_namespace_string,
}
